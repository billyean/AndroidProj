...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "ZWVJBiChGAjuwlBaczVwSywK7";       // Change this
    public static final String REST_CONSUMER_SECRET = "zN3jpJzX9TfyUo5uV2ixMynvy7Qu3x6hRlPrZ1yVMxXs2ZgLdl"; // Change this
